...
##################################
    ...
    if features_imgPath:
        ...
        imgNames=[features_imgPath+f"/{feature_names[i]}.png" for i in feature_order]       
        ...
        ax.text(xlimitSup/2, -row_height*2, 'toxic', size=13, color='red', ha="center", transform=ax.transData)
        ax.text(xlimitInf/2, -row_height*2, 'non-toxic', size=13, color='green', ha="center", transform=ax.transData)
